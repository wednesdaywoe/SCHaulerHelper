 ...
 * Marker colors for each visual theme
 * Used in delivery organizer, cargo grid, and route planner
 */
...
const THEME_COLOR_PALETTES = {
    ...
    'cetacean': ['#00D4FF', '#FF1B8D', '#00CBA0', '#FF69B4', '#00A8CC', '#B026FF', '#00E5FF', '#FF006E'],
